...
export const addResizeListener = function (element: ResizableElement, fn: Function) {
    if (isServer) {
        return
    }
...
export const removeResizeListener = function (element: ResizableElement, fn: Function) {
